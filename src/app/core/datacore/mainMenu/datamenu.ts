...
export const MENU_ELEMENTS: DataMenuInterface[] = [
  {
    ...
    active: true,
    icon: 'fa-sharp fa-thin fa-palette',
  },
  {
    name: 'Poligrafia firmowa',
    link: '/poligrafia-firmowa',
    active: true,
    icon: 'fa-sharp fa-thin fa-print',
  },
  {
    name: 'Identyfikacja wizualna',
    link: '/identyfikacja-wizualna',
    active: true,
    icon: 'fa-sharp fa-thin fa-pen-ruler',
  },
  {
    name: 'Strony internetowe',
    link: '/strony-internetowe',
    active: true,
    icon: 'fa-sharp fa-thin fa-globe',
  },
  {
    name: 'Analiza danych',
    link: '/analiza-danych',
    active: true,
    icon: 'fa-sharp fa-thin fa-chart-line',
  },
  {
    name: 'Usługi dronowe',
    link: '/uslugi-dronowe',
    active: true,
    icon: 'fa-sharp fa-thin fa-drone-front',
  },
];
